...
public interface IAnnealingSchedule {
	...
	/**
	 * Cool the system down by one step. How much that is
	 * or if the system is cooled at all is left to the
	 * implementation.
	 *
	 * @return True, if the system did the cooling step, false if it has reached the end.
	 */
	public boolean cool();
	 ...
	 *
	 * @return A verbose representation of this schedule
	 */
